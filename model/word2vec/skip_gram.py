...
class SkipGram(Layer):
    ...
    def build(self):
        ...
        target_embedding = Reshape(target_shape=(self.embedding_size,), name="Reshape Target")(target_embedding)
        context_embedding = embedding_layer(input_context)
        context_embedding = Reshape(target_shape=(self.embedding_size,), name="Reshape Context")(context_embedding)

        product_result = Dot(axes=1, name="product 1")([target_embedding, context_embedding])
